...
//The variable "weapon" was only declared in the Fighter subclass. Instances of subclasses cannot use variables or methods declared in parallel subclasses under the same superclass.
