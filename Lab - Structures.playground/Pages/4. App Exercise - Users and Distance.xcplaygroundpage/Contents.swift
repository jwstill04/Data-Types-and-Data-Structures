...
var jacob = User(name: "Jacob", age: 17, height: 67, weight: 185, activityLevel: 4)

print("\(jacob.name) is \(jacob.age) years old, has a height of \(jacob.height) inches, a weight of \(jacob.weight) pounds, and an activity level of \(jacob.activityLevel)")
/*:
...
let distance = Distance(meters: 700)
print(distance.feet, distance.meters)
/*:
