 ...
 */
let nameInCaps = "Jacob"
let name = "jacob"
nameInCaps == name ? print("The two strings are equal") : print("The two strings are not equal")
/*:
 ...
 */
nameInCaps.lowercased() == name.lowercased() ? print("\(nameInCaps.lowercased()) and \(name.lowercased()) are the same.") : print("\(nameInCaps.lowercased()) and \(name.lowercased()) are not the same.")
