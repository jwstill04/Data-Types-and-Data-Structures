...
print("Using the term 'let' to declare a constant means that you are unable to change it. In order to change it, you would need to declare it as a 'var', or variable.")
